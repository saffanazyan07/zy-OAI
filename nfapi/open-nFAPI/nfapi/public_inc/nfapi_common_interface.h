...
typedef struct nfapi_p4_p5_codec_config {
	 ...
	 * If not set the message will be ignored
	 */
	int (*unpack_p4_p5_vendor_extension)(void* header, uint8_t **ppReadPackedMsg, uint8_t *end, struct nfapi_p4_p5_codec_config* config);
	 ...
	 *  If not set the the message will be ingored
	 */
	int (*pack_p4_p5_vendor_extension)(void* header, uint8_t **ppwritepackedmsg, uint8_t *end, struct nfapi_p4_p5_codec_config* config);
