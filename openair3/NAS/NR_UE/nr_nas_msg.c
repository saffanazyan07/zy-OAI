...
void generateRegistrationRequest(as_nas_info_t *initialNasMsg, nr_ue_nas_t *nas, bool is_security_mode)
{
  ...
  int size = sizeof(mm_msg_header_t); // cleartext size
  ...
  registration_request_msg *rr = &mm_msg->registration_request;
  ...
  MM_msg full_mm = *mm_msg;
  registration_request_msg *full_rr = &full_mm.registration_request;
...
static void generateSecurityModeComplete(nr_ue_nas_t *nas, as_nas_info_t *initialNasMsg)
{
  ...
  FGCNasMessageContainer *container = &mm_msg->fgs_security_mode_complete.fgsnasmessagecontainer;
